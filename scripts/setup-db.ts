  ...
  try {
    ...
    try {
      ...
      if (error && error.code === "PGRST204") {
        // Table doesn't exist
        console.log(
          "Users table does not exist. Please run the following SQL in Supabase SQL Editor:"
        );
        console.log(`
    ...
    try {
      ...
      if (error && error.code === "PGRST204") {
        // Table doesn't exist
        console.log(
          "Products table does not exist. Please run the following SQL in Supabase SQL Editor:"
        );
        console.log(`
    ...
    try {
      ...
      if (error && error.code === "PGRST204") {
        // Table doesn't exist
        console.log(
          "Transactions table does not exist. Please run the following SQL in Supabase SQL Editor:"
        );
        console.log(`
    ...
    try {
      ...
      if (error && error.code === "PGRST204") {
        // Table doesn't exist
        console.log(
          "Transaction items table does not exist. Please run the following SQL in Supabase SQL Editor:"
        );
        console.log(`
